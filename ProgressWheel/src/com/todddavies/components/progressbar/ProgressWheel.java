...
public class ProgressWheel extends View {
    ...
    private void parseAttributes(TypedArray a) {
        ...
        barLengthPEDA = (int) a.getDimension(R.styleable.ProgressWheel_barLengthPEDA,
                barLengthPEDA);
    ...
    protected void onDraw(Canvas canvas) {
        ...
        //Draw the bar
        if (isSpinning) {
            canvas.drawArc(circleBounds, progress - 90, barLengthPEDA, false,
                    barPaint);
        } else {
...
//        setText(Math.round(((float) progress / 360) * 100) + "%");
    ...
    public int getBarLength() {
        return barLengthPEDA;
    }

    public void setBarLength(int barLengthPEDA) {
        this.barLengthPEDA = barLengthPEDA;
    }
