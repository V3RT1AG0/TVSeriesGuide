package compdom.sad.RotatingCirlce;
...
import compdom.sad.MyApplication;
import compdom.sad.R;
...
public class CountdownTimerActivity extends AppCompatActivity
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
       ...
       // setContentView(R.layout.activity_main2);
        new Toastnotify(getApplicationContext(), "superclass executed");
        configureViews();
    ...
    private void configureViews()
    {
        ...
        new Toastnotify(getApplicationContext(), "superclass executed 2"+ mDaysLabel.getText());
